...
if ( !class_exists( 'smtrWp_Table_Core' ) ) {
...
{ 
    ...
    public function setSearch($cols=array()){
    ...
    function prepare_items($data,$ttl_items,$rpp)
    {
